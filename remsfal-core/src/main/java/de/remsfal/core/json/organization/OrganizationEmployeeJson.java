...
public abstract class OrganizationEmployeeJson implements OrganizationEmployeeModel {
    ...
    @Null
    @Nullable
    @Schema(readOnly = true, description = "Unique identifier of the employee (generated by server)")
    @Override
    ...
    @Null
    @Nullable
    @Schema(readOnly = true, description = "Full name of the employee (retrieved from user profile)")
    @Override
