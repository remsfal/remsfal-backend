...
/**
 * JSON representation of a building rent.
 *
 * @author Alexander Stanik [alexander.stanik@htw-berlin.de]
 */
@Immutable
@ImmutableStyle
@Schema(description = "Building rent information")
@JsonDeserialize(as = ImmutableBuildingRentJson.class)
@JsonNaming(PropertyNamingStrategies.LowerCamelCaseStrategy.class)
public abstract class BuildingRentJson implements RentModel {
