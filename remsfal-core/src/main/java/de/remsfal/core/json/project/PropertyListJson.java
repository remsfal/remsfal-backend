...
public abstract class PropertyListJson {
    ...
    @Schema(description = "Index of the first element in property list of total available entries, starting at 1",
        required = true, example = "1")
    public abstract Integer getFirst();

    @Schema(description = "Number of elements in property list", minimum = "1", maximum = "100",
        defaultValue = "10", required = true)
    public abstract Integer getSize();

    @Schema(description = "Total number of available properties", required = true)
