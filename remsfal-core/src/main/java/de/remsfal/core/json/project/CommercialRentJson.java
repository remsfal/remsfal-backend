...
/**
 * JSON representation of a commercial rent.
 *
 * @author Alexander Stanik [alexander.stanik@htw-berlin.de]
 */
@Immutable
@ImmutableStyle
@Schema(description = "Commercial rent information")
@JsonDeserialize(as = ImmutableCommercialRentJson.class)
@JsonNaming(PropertyNamingStrategies.LowerCamelCaseStrategy.class)
public abstract class CommercialRentJson implements RentModel {
