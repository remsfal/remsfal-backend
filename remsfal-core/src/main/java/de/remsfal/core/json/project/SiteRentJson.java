...
/**
 * JSON representation of a site rent.
 *
 * @author Alexander Stanik [alexander.stanik@htw-berlin.de]
 */
@Immutable
@ImmutableStyle
@Schema(description = "Site rent information")
@JsonDeserialize(as = ImmutableSiteRentJson.class)
@JsonNaming(PropertyNamingStrategies.LowerCamelCaseStrategy.class)
public abstract class SiteRentJson implements RentModel {
