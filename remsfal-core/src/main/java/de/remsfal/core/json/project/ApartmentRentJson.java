...
/**
 * JSON representation of an apartment rent.
 *
 * @author Alexander Stanik [alexander.stanik@htw-berlin.de]
 */
@Immutable
@ImmutableStyle
@Schema(description = "Apartment rent information")
@JsonDeserialize(as = ImmutableApartmentRentJson.class)
@JsonNaming(PropertyNamingStrategies.LowerCamelCaseStrategy.class)
public abstract class ApartmentRentJson implements RentModel {
