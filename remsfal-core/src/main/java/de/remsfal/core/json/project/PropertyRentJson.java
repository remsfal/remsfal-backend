...
/**
 * JSON representation of a property rent.
 *
 * @author Alexander Stanik [alexander.stanik@htw-berlin.de]
 */
@Immutable
@ImmutableStyle
@Schema(description = "Property rent information")
@JsonDeserialize(as = ImmutablePropertyRentJson.class)
@JsonNaming(PropertyNamingStrategies.LowerCamelCaseStrategy.class)
public abstract class PropertyRentJson implements RentModel {
