...
/**
 * Validator implementation for {@link AtLeastOneRentUnit} annotation.
 * Checks that at least one rent unit list (apartmentRents, buildingRents, propertyRents,
 * siteRents, storageRents, commercialRents) is not empty.
 *
    ...
    public boolean isValid(RentalAgreementJson value, ConstraintValidatorContext context) {
        ...
        if (!hasAtLeastOneRent) {
            ...
            context.buildConstraintViolationWithTemplate(
                    "At least one rent unit (apartmentRents, buildingRents, propertyRents, siteRents, storageRents, or commercialRents) must be specified")
