...
public class TaskRepository extends AbstractRepository<TaskEntity> {
    ...
    public List<TaskEntity> findTaskByProjectId(final Type type, final String projectId) {
        return find("type = :type and projectId = :projectId",
            Parameters.with(PARAM_TYPE, type).and(PARAM_PROJECT_ID, projectId))
            .list();
    }

    public List<TaskEntity> findTaskByProjectId(final Type type, final String projectId, final Status status) {
    ...
    public List<TaskEntity> findTaskByOwnerId(final Type type, final String projectId, final String ownerId) {
    ...
    public Optional<TaskEntity> findTaskById(final Type type, final String projectId, final String taskId) {
    ...
    public long deleteTaskById(final Type type, final String projectId, final String taskId) {
