...
public abstract class AbstractResourceTest extends AbstractServiceTest {
    ...
    protected void setupTestUsers() {
        insertAddress(TestData.ADDRESS_ID_1.toString(), TestData.ADDRESS_STREET_1, TestData.ADDRESS_CITY_1,
            TestData.ADDRESS_PROVINCE_1, TestData.ADDRESS_ZIP_1, TestData.ADDRESS_COUNTRY_1);
        insertUser(TestData.USER_ID_1.toString(), TestData.USER_TOKEN_1, TestData.USER_EMAIL_1,
            TestData.USER_FIRST_NAME_1, TestData.USER_LAST_NAME_1, TestData.ADDRESS_ID_1);
        insertAddress(TestData.ADDRESS_ID_2.toString(), TestData.ADDRESS_STREET_2, TestData.ADDRESS_CITY_2,
            TestData.ADDRESS_PROVINCE_2, TestData.ADDRESS_ZIP_2, TestData.ADDRESS_COUNTRY_2);
        insertUser(TestData.USER_ID_2.toString(), TestData.USER_TOKEN_2, TestData.USER_EMAIL_2,
            TestData.USER_FIRST_NAME_2, TestData.USER_LAST_NAME_2, TestData.ADDRESS_ID_2);
        insertAddress(TestData.ADDRESS_ID_3.toString(), TestData.ADDRESS_STREET_3, TestData.ADDRESS_CITY_3,
            TestData.ADDRESS_PROVINCE_3, TestData.ADDRESS_ZIP_3, TestData.ADDRESS_COUNTRY_3);
        insertUser(TestData.USER_ID_3.toString(), TestData.USER_TOKEN_3, TestData.USER_EMAIL_3,
            TestData.USER_FIRST_NAME_3, TestData.USER_LAST_NAME_3, TestData.ADDRESS_ID_3);
        insertAddress(TestData.ADDRESS_ID_4.toString(), TestData.ADDRESS_STREET_4, TestData.ADDRESS_CITY_4,
            TestData.ADDRESS_PROVINCE_4, TestData.ADDRESS_ZIP_4, TestData.ADDRESS_COUNTRY_4);
        insertUser(TestData.USER_ID_4.toString(), TestData.USER_TOKEN_4, TestData.USER_EMAIL_4,
    ...
    protected void setupTestProjects() {
        ...
        insertProject(TestData.PROJECT_ID_1.toString(), TestData.PROJECT_TITLE_1);
        insertProjectMember(TestData.PROJECT_ID_1.toString(), TestData.USER_ID.toString(), "MANAGER");
        insertProject(TestData.PROJECT_ID_2.toString(), TestData.PROJECT_TITLE_2);
        insertProjectMember(TestData.PROJECT_ID_2.toString(), TestData.USER_ID.toString(), "MANAGER");
        insertProject(TestData.PROJECT_ID_3.toString(), TestData.PROJECT_TITLE_3);
        insertProjectMember(TestData.PROJECT_ID_3.toString(), TestData.USER_ID.toString(), "MANAGER");
        insertProject(TestData.PROJECT_ID_4.toString(), TestData.PROJECT_TITLE_4);
        insertProjectMember(TestData.PROJECT_ID_4.toString(), TestData.USER_ID.toString(), "MANAGER");
        insertProject(TestData.PROJECT_ID_5.toString(), TestData.PROJECT_TITLE_5);
        insertProjectMember(TestData.PROJECT_ID_5.toString(), TestData.USER_ID.toString(), "MANAGER");
    }

    protected void setupTestProperties() {
        insertProperty(TestData.PROPERTY_ID_1.toString(), TestData.PROJECT_ID.toString(), TestData.PROPERTY_TITLE_1,
        ...
        insertProperty(TestData.PROPERTY_ID_2.toString(), TestData.PROJECT_ID.toString(), TestData.PROPERTY_TITLE_2,
        ...
        insertProperty(convert(UUID.randomUUID()), TestData.PROJECT_ID_2, TestData.PROPERTY_TITLE_1,
            TestData.PROPERTY_LOCATION_2, TestData.PROPERTY_DESCRIPTION_2, TestData.PROPERTY_LAND_REGISTRY_2,
            TestData.PROPERTY_CADASTRAL_DESTRICT_2, TestData.PROPERTY_SHEET_NUMBER_2,
            TestData.PROPERTY_PLOT_NUMBER_2, TestData.PROPERTY_CADASTRAL_SECTION_2,
            TestData.PROPERTY_PLOT_2, TestData.PROPERTY_ECONOMY_TYPE_2, TestData.PROPERTY_PLOT_AREA_2);
        insertProperty(convert(UUID.randomUUID()), TestData.PROJECT_ID_3, TestData.PROPERTY_TITLE_2,
            TestData.PROPERTY_LOCATION_2, TestData.PROPERTY_DESCRIPTION_2, TestData.PROPERTY_LAND_REGISTRY_2,
            TestData.PROPERTY_CADASTRAL_DESTRICT_2, TestData.PROPERTY_SHEET_NUMBER_2,
            TestData.PROPERTY_PLOT_NUMBER_2, TestData.PROPERTY_CADASTRAL_SECTION_2,
            TestData.PROPERTY_PLOT_2, TestData.PROPERTY_ECONOMY_TYPE_2, TestData.PROPERTY_PLOT_AREA_2);
    ...
    protected void setupTestSites() {
        insertAddress(TestData.ADDRESS_ID_5.toString(), TestData.ADDRESS_STREET_5, TestData.ADDRESS_CITY_5,
            TestData.ADDRESS_PROVINCE_5, TestData.ADDRESS_ZIP_5, TestData.ADDRESS_COUNTRY_5);
        insertSite(TestData.SITE_ID_1.toString(), TestData.PROJECT_ID.toString(), TestData.PROPERTY_ID, TestData.SITE_TITLE_1,
            TestData.ADDRESS_ID_5, TestData.SITE_DESCRIPTION, TestData.SITE_OUTDOOR_AREA);
    }

    protected void setupTestBuildings() {
        insertAddress(TestData.ADDRESS_ID_6.toString(), TestData.ADDRESS_STREET_6, TestData.ADDRESS_CITY_6,
            TestData.ADDRESS_PROVINCE_6, TestData.ADDRESS_ZIP_6, TestData.ADDRESS_COUNTRY_6);
        insertBuilding(TestData.BUILDING_ID_1.toString(), TestData.PROJECT_ID.toString(), TestData.PROPERTY_ID,
            TestData.BUILDING_TITLE_1, TestData.BUILDING_DESCRIPTION_1,
            null, null, null, null, null, null, TestData.ADDRESS_ID_6);
        insertAddress(TestData.ADDRESS_ID_7.toString(), TestData.ADDRESS_STREET_7, TestData.ADDRESS_CITY_7,
            TestData.ADDRESS_PROVINCE_7, TestData.ADDRESS_ZIP_7, TestData.ADDRESS_COUNTRY_7);
        insertBuilding(TestData.BUILDING_ID_2.toString(), TestData.PROJECT_ID.toString(), TestData.PROPERTY_ID,
        ...
        insertApartment(TestData.APARTMENT_ID_1.toString(), TestData.PROJECT_ID.toString(), TestData.BUILDING_ID,
        ...
        insertApartment(TestData.APARTMENT_ID_2.toString(), TestData.PROJECT_ID.toString(), TestData.BUILDING_ID,
        ...
        insertCommercial(TestData.COMMERCIAL_ID_1.toString(), TestData.PROJECT_ID.toString(), TestData.BUILDING_ID,
        ...
        insertCommercial(TestData.COMMERCIAL_ID_2.toString(), TestData.PROJECT_ID.toString(), TestData.BUILDING_ID,
        ...
        insertStorage(TestData.STORAGE_ID_1.toString(), TestData.PROJECT_ID.toString(), TestData.BUILDING_ID,
            TestData.STORAGE_TITLE_1, TestData.STORAGE_LOCATION_1, TestData.STORAGE_DESCRIPTION_1,
            TestData.STORAGE_USABLE_SPACE_1);
        insertStorage(TestData.STORAGE_ID_2.toString(), TestData.PROJECT_ID.toString(), TestData.BUILDING_ID,
    ...
    protected void insertAddress(Object... params) {
        runInTransaction(() -> entityManager
                ...
                .setParameter(1, convert(params[0]))
    ...
    protected void insertUser(Object... params) {
        runInTransaction(() -> entityManager
                ...
                .setParameter(1, convert(params[0]))
                .setParameter(2, convert(params[1]))
                .setParameter(3, params[2])
                .setParameter(4, params[3])
                .setParameter(5, params[4])
                .setParameter(6, convert(params[5]))
                .executeUpdate());
    }
    ...
    protected void insertSite(Object... params) {
        runInTransaction(() -> entityManager
                ...
                .setParameter(1, convert(params[0]))
                .setParameter(2, convert(params[1]))
                .setParameter(3, convert(params[2]))
                .setParameter(4, params[3])
                .setParameter(5, convert(params[4]))
                .setParameter(6, params[5])
                .setParameter(7, params[6])
                .executeUpdate());
    }
    ...
    protected void insertBuilding(Object... params) {
        runInTransaction(() -> entityManager
                ...
                .setParameter(10, params[9])
                .setParameter(11, params[10])
                .setParameter(12, convert(params[11]))
                .executeUpdate());
    }
