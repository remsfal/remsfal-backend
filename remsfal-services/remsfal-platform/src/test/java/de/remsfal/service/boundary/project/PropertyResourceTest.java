...
class PropertyResourceTest extends AbstractResourceTest {
    ...
    void getProperties_SUCCESS_propertiesCorrectlyReturned() {
        ...
        given()
            ...
            .and().body("properties[0].key", Matchers.equalTo(TestData.PROPERTY_ID_2.toString()))
            .and().body("properties[1].key", Matchers.equalTo(TestData.PROPERTY_ID_1.toString()))
            ...
            .and().body("properties[1].children[0].key", Matchers.equalTo(TestData.BUILDING_ID_1.toString()))
            ...
            .and().body("properties[1].children[1].key", Matchers.equalTo(TestData.BUILDING_ID_2.toString()))
            ...
            .and().body("properties[1].children[0].children[0].key", Matchers.equalTo(TestData.APARTMENT_ID_1.toString()))
            ...
            .and().body("properties[1].children[0].children[1].key", Matchers.equalTo(TestData.APARTMENT_ID_2.toString()))
            ...
            .and().body("properties[1].children[0].children[2].key", Matchers.equalTo(TestData.COMMERCIAL_ID_1.toString()))
            ...
            .and().body("properties[1].children[0].children[3].key", Matchers.equalTo(TestData.COMMERCIAL_ID_2.toString()))
            ...
            .and().body("properties[1].children[0].children[4].key", Matchers.equalTo(TestData.STORAGE_ID_1.toString()))
            ...
            .and().body("properties[1].children[0].children[5].key", Matchers.equalTo(TestData.STORAGE_ID_2.toString()))
